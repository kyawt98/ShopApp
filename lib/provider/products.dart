...
class Products with ChangeNotifier {
  List<Product> _items = [
    Product(
        id: 'p1',
        title: 'Midweight Casual Solid Cargo Jogger Pants ',
    ...
    Product(
        id: 'p2',
        title: 'Starter Women Soccer Pants',
    ...
    Product(
        id: 'p3',
        title:
            'Motion Tech Fleece Relaxed Fit Jogger Sweatpant  ',
    ...
    Product(
        id: 'p4',
        title:
            'Sleepwear Marshmallow Fleece Pullover Top and Jogger Pajama Set  ',
        description: '  100% Polyester  ',
        price: 22.04,
        imgUrl:
    ...
    Product(
        id: 'p5',
        title: 'Goodthreads Women Denim Cargo Jeans  ',
    ...
    Product(
        id: 'p6',
        title:
            'Greta Fitted Square Neck Halter Sweater Bralette',
    ...
    Product(
        id: 'p7',
        title: 'Dina Fleece Elastic Hem Sweatpant  ',
